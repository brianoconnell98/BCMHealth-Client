...
I used this itially to set up my mongodb connection and set up a basic react and node website
https://medium.com/swlh/how-to-create-your-first-mern-mongodb-express-js-react-js-and-node-js-stack-7e8b20463e66


I got help off a fellow class mate. Adam O'Ceallaigh. 
...
I used all of the MongoDb website in order to obtain to connect to the database. I done so using the application method with the 
assistance from pages like this. 
https://docs.mongodb.com/guides/server/drivers/
https://www.mongodb.com/


I also followed TraversyMedia on YouTube they are a great follow for coding assistance and also for tutorials on all aspects of coding

This is link to the YouTube channel they have
